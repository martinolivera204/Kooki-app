...
export default function AhorroExpress() {
  ...
  if (!premium) {
    return (
      <div style={{ background: "#F5F5F7", minHeight: "100vh", fontFamily: F, color: "#1B1B1B", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <style>{`@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap');`}</style>
        <div style={{ textAlign: "center", maxWidth: 400 }}>
          <img src={AHORROEXPRESS_LOGO} alt="AhorroExpress" style={{ height: 80, objectFit: "contain", marginBottom: 24 }} />
          <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 10, letterSpacing: "-0.03em" }}>Contenido <span style={{ color: "#D97706" }}>Premium</span></h2>
          <p style={{ fontSize: 15, color: "#6B7280", lineHeight: 1.6, marginBottom: 28 }}>AhorroExpress es exclusivo para usuarios Premium de Kooki. Desbloqueá todas las herramientas con un único pago.</p>
          <a href={CHECKOUT_URL} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "16px 32px", borderRadius: 14, background: "#1B1B1B", color: "#fff", fontSize: 16, fontWeight: 700, textDecoration: "none", marginBottom: 16 }}>Quiero Premium · $20.900</a>
          <br />
          <a href="/" style={{ fontSize: 14, color: "#6B7280", fontWeight: 600, textDecoration: "none" }}>← Volver a Kooki</a>
        </div>
      </div>
    );
  }

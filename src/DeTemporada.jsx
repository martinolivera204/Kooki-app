...
const LOGO = "https://cdn.shopify.com/s/files/1/0983/2857/6366/files/DeTempradasi_SINFONDO.png?v=1776961426";
    ...
    return (
      <div style={{ background: cr, minHeight: "100vh", fontFamily: F, color: ink, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        ...
        <div style={{ textAlign: "center", maxWidth: 400 }}>
          <img src={LOGO} alt="DeTemporada" style={{ height: 80, objectFit: "contain", marginBottom: 24 }} />
  ...
  return (
    <div style={{ background: cr, minHeight: "100vh", fontFamily: F, color: ink, WebkitFontSmoothing: "antialiased", paddingBottom: 40 }}>
      ...
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: cr + "ee", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(45,106,79,0.08)" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 20px", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center" }}>
            <img src={LOGO} alt="DeTemporada" style={{ height: 52, objectFit: "contain" }} onError={e => { e.target.style.display = "none"; e.target.nextSibling.style.display = "flex"; }} />
      ...
      <footer style={{ borderTop: "1px solid rgba(45,106,79,0.08)", padding: "40px 20px", textAlign: "center", background: cr }}>
        <img src={LOGO} alt="DeTemporada" style={{ height: 48, objectFit: "contain", marginBottom: 10 }} onError={e => { e.target.style.display = "none"; }} />
